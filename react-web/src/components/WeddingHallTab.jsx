...
function WeddingHallTab({ weddingHall, setWeddingHall }) {
        ...
        <table style={{ margin: "30px auto" }}>
          <thead>
            <tr>
              ...
              <th>Giá tối</th>
              <th>Giá cuối tuần</th>
              {weddingHall === "" && <th>Thao tác</th>}
            </tr>
          </thead>
          <tbody>
            {weddingHalls.map((weddingHallMap) => (
              <tr key={weddingHallMap.id}>
                <td style={{ textAlign: "center" }}>{weddingHallMap.id}</td>
                <td style={{ textAlign: "center" }}>
                  {weddingHallMap.weddingHallName}
                </td>
                <td style={{ textAlign: "center" }}>
                  {weddingHallMap.weddingHallLocation}
                </td>
                <td>{weddingHallMap.morningPrice}</td>
                <td>{weddingHallMap.noonPrice}</td>
                <td>{weddingHallMap.eveningPrice}</td>
                <td>{weddingHallMap.weekendPrice}</td>
                {weddingHall === "" && (
                  <td
                    style={{
                      textAlign: "center",
                  ...
                  >
                    <div
                      ...
                      onClick={(e) => setWeddingHall(weddingHallMap)}
                    >
                      Chọn
                    </div>
                  </td>

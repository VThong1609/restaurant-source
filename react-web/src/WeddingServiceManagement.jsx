...
function WeddingServiceManagement() {
          ...
          <tbody>
            {weddingServices.map((weddingService) => (
              <tr key={weddingService.id}>
                ...
                >
                  <>
                    {weddingService.status !== "ACTIVE" ? (
                      <CustomButton
                        field={weddingService.id}
                        IconButton={BsFillLockFill}
                        size={30}
                        color="black"
                        func={changeStatus}
                        title={"Disable WeddingService"}
                        id={`td-status-disable-${weddingService.id}`}
                      ...
                      <CustomButton
                        ...
                        color="black"
                        func={changeStatus}
                        title={"Enable WeddingService"}
                        id={`td-status-enable-${weddingService.id}`}
                        style={{ marginRight: 15 }}
                      />
                    )}
                    <CustomButton
                      ...
                      color="black"
                      func={() =>
                        navigate(`/EditWeddingService/${weddingService.id}`)
                      }
                      title={"Sửa dịch vụ"}
                      id={`edit-${weddingService.id}`}
                      style={{ marginLeft: 15 }}
                    />
                  </>
                </td>
...
export default WeddingServiceManagement;
